  ...
  return (
    <div className="min-h-screen bg-[#FCFBF7] text-[#1F2937] font-sans selection:bg-[#E11D48] selection:text-white pb-24">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "¿Qué pasa si las flores perecederas se marchitan o el cliente cancela el pedido?", "acceptedAnswer": {"@type": "Answer", "text": "Usted paga exactamente $0.00. La regla de oro de Socio es que nuestra comisión solo se liquida si el dinero del cliente se acredita satisfactoriamente en su cuenta o terminal POS. Si una entrega se cancela, se devuelve o no se cobra, no existe ninguna comisión adeudada."}}, {"@type": "Question", "name": "¿Cómo controlan la sobrecarga de pedidos en San Valentín y el Día de las Madres?", "acceptedAnswer": {"@type": "Answer", "text": "Nuestra asistente virtual \"Rosa\" cuenta con un regulador de cupos. Cuando usted alcanza su capacidad máxima diaria de armado y reparto de arreglos, el sistema deja de aceptar pedidos inmediatos y pasa a programar fechas posteriores o activar lista de espera con prepago obligatorio."}}, {"@type": "Question", "name": "¿Quién se encarga del reparto físico de los arreglos en los 5 Boroughs?", "acceptedAnswer": {"@type": "Answer", "text": "Su floristería mantiene el control de sus choferes o servicios locales de mensajería (como DoorDash Drive, Relay o choferes propios). Socio actúa como el motor comercial y de captación que asegura el cobro anticipado del ramo y la tarifa de envío antes de que salga de su taller."}}, {"@type": "Question", "name": "¿Cómo concilian las comisiones con mi sistema de cobro (Square, Clover, Shopify POS o Stripe)?", "acceptedAnswer": {"@type": "Answer", "text": "Nos conectamos mediante webhook seguro de lectura a su procesador de pagos. El sistema solo registra comisiones cuando una transacción tiene estado \"settled\" o \"cleared\". Cero reportes manuales o cálculos engorrosos."}}, {"@type": "Question", "name": "¿Cómo funciona exactamente el Tope Anual Protegido de $15,000?", "acceptedAnswer": {"@type": "Answer", "text": "Garantizamos por contrato que una vez que su floristería haya pagado $15,000 en comisiones dentro de un año fiscal, nuestra comisión baja automáticamente a 0.0% para todas las ventas restantes de ese año. Sin letras pequeñas."}}, {"@type": "Question", "name": "¿Qué comisión se aplica a las suscripciones corporativas semanales de hoteles y oficinas?", "acceptedAnswer": {"@type": "Answer", "text": "Las cuentas corporativas B2B tienen una tasa reducida preferencial del 5% (en comparación con el 8% de pedidos minoristas directos), reconociendo el alto volumen y la predictibilidad del contrato a largo plazo."}}]}) }}
      />
