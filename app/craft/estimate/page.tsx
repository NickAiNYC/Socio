...
export default function EstimatePage() {
  return (
    <div className="w-full bg-neutral-50 min-h-screen py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto mb-12 text-center">
        <h1 className="font-display text-4xl md:text-5xl font-semibold tracking-tight text-neutral-900 mb-4">
          Request an Estimate
        </h1>
